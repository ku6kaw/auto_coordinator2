...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            /* body{margin:0} */
            /* log in とregisterの背景色が変わる */
            a{background-color:transparent}
            .b{
                margin: 0;
                width: 100vw;
                height: 100vh;
                background-image:url("https://www.linustock.com/images/uploads/2017/12/1512970557.png")
                ,url("https://tyoudoii-illust.com/wp-content/uploads/2020/12/engineer_man_mono.png ");
                background-repeat: no-repeat;
                background-position:50% 50%,48% 49%;
                background-size:cover,10%
                
             }
            
            .c{background-color:#FAFAD2} */
            /* [hidden]{display:none} */
            ...
            .ml-4{margin-left:10rem}
            .mt-8{margin-top:10rem}
            .mt-25{margin-top: 18rem}
            /* 真ん中に持ってくるように設定したmargin */
            .ml-12{margin-left:31rem}
    ...
    <body class="antialiased b c">
        <div class=" underline  fixed  ml-12 mt-8">
            <h1 class=" ">Auto Coordinator</h1>
        </div>
        <div class="relative  items-top justify-center min-h-screen bg-gray-50 dark:bg-gray-900 sm:items-center ">
            @if (Route::has('login'))
                <div class="hidden  mt-25 ml-12 fixed   sm:block">
            ...
            <!-- <div class="max-w-6xl mx-auto sm:px-6 lg:px-8"> -->
                ...
                <!-- <div class="flex justify-center pt-5 sm:justify-start sm:pt-0"> -->
